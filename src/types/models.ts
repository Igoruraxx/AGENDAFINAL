/**
 * Business model types — application-level representations of database rows.
 * These use camelCase and may differ slightly from the DB column names.
 *
 * Database ↔ model mapping is handled in the corresponding hooks.
 */
...
export type EventType = 'appointment' | 'task' | 'reminder' | 'block';
